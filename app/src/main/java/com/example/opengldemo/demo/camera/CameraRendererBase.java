 ...
 */
public class CameraRendererBase implements GLSurfaceView.Renderer {
    ...
    public CameraRendererBase(GLSurfaceView glSurfaceView) {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        // init program
        mProgramHandle = ProgramUtil.createAndLinkProgram(glSurfaceView.getContext(), getVertexFile(), getFragmentFile(), null);
    ...
    protected String getVertexFile() {
        return "camera/vertex_texture.glsl";
    }

    protected String getFragmentFile() {
        return "camera/fragment_texture.glsl";
    }
}
