...
public class Camera2Activity extends BaseActivity implements Camera.PreviewCallback {
    ...
    protected void onCreate ( Bundle savedInstanceState )
    {
        ...
        mGLSurfaceView.setRenderer (new Camera2Renderer(mGLSurfaceView));
    ...
    protected Camera initCamera() {
        try {
            ...
            camera.setPreviewCallback(Camera2Activity.this);
            return camera;
        } catch (IOException e) {
            L.d(e.toString());
        }
